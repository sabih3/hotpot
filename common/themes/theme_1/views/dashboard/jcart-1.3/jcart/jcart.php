...
class Jcart {
    ...
    */
    public function display_cart() {
        ...
        echo tab(5) . "</tr>". "\n";
        echo tab(5) . "<tr>\n";
        echo tab(6) . "<th colspan='3' class='shead-jcart'>\n";
        echo tab(7) . "<strong id='jcart-title'></strong> \n";
        echo tab(6) . "</th>\n";        
        echo tab(5) . "</tr>". "\n";        
        echo tab(4) . "</thead>\n";
        ...
        echo tab(7) . "<span class='bill-detail-link'><a href='#' id='bill-detail'>Bill Detail</a></span><span id='jcart-subtotal'>{$config['text']['subtotal']}: <strong>$currencySymbol" . number_format($this->subtotal, $priceFormat['decimals'], $priceFormat['dec_point'], $priceFormat['thousands_sep']) . "</strong></span>\n";
        echo tab(6) . "</th>\n";
        echo tab(5) . "</tr>\n";        
        echo tab(4) . "</tfoot>\n";          
        echo tab(4) . "<tbody>\n";
        ...
        if($this->itemCount > 0) {
            ...
            foreach($this->get_contents() as $item) {
                ...
                echo tab(7) . "<input type='button' value='-' class='qtyminus' field='quantity' /><input class='qty' id='jcartItemQty-{$item['id']}' name='jcartItemQty[]' size='2' type='text' value='{$item['qty']}' /><input type='button' value='+' class='qtyplus' field='quantity' />\n";
        ...
        echo tab(3) . "<tr class='subtotal' id='subtotal-details'>\n";
        echo tab(3) . "<td colspan='3'>\n";
        echo tab(3) . "<div class='jcart-subtitle'>Sub-total:<span class='cart-sub-amount'>Rs. 0</span></div>\n";
        echo tab(3) . "<div class='jcart-subtitle'>Discount (0%):<span class='cart-sub-amount'>Rs. 0</span></div>\n";
        echo tab(3) . "<div class='jcart-subtitle'>Delivery fee:<span class='cart-sub-amount'>Rs. 50</span></div>\n";
        echo tab(3) . "<div class='jcart-subtitle'>Creditcard Discount (0%):<span class='cart-sub-amount'>Rs. 0</span></div>\n";                
        echo tab(3) . "<div class='jcart-subtitle'>Convenience fee (5%):<span class='cart-sub-amount'>Rs. 0</span></div>\n";                
